...
import serie2 from '../src/coupes/serie2.webp'
...
import a5 from '../src/coupes/a5.webp'
import tt from '../src/coupes/tt.webp'
import etron from '../src/coupes/etron.webp'
import p911 from '../src/coupes/p911.webp'
import serie240 from '../src/coupes/serie240.webp'
import mustange from '../src/coupes/mustange.webp'
...
import mustang from '../src/coupes/mustang.webp'
import { motion,AnimatePresence } from 'framer-motion';
import TextField from '@mui/material/TextField';
import Autocomplete from '@mui/material/Autocomplete';
import focus from '../src/hatchbackimages/focus.webp'
import supra from '../src/coupes/supra.webp'
import Button from '@mui/material/Button';
import Snackbar from '@mui/material/Snackbar';
import IconButton from '@mui/material/IconButton';
import serie8 from '../src/coupes/serie8.webp'
...
const Coupes = () => {
  ...
  const cars = [
    { title: 'BMW 2 Series Gran Coupe', brand: 'BMW', fuel: 'Petrol', price: '30,449$',description:'Four-door coupe', image: serie2},
    { title: 'Audi A5 Sportback', brand: 'Audi', fuel: 'Diesel', price: '39,612$',description:'Classy four-door coupe', image: a5 },
    { title: 'Audi TT', brand: 'Audi', fuel: 'Petrol', price: '33,044$',description:'Excellent sport car and great to drive', image: tt },
    { title: 'Ford Mustang', brand: 'Ford', fuel: 'Petrol', price: '37,824$',description:'Charismatic sport car', image: mustang },
    { title: 'Toyota Supra', brand: 'Toyota', fuel: 'Petrol', price: '36,044$',description:'Two-seat with powerful engine', image: supra },
    { title: 'Audi e-tron GT', brand: 'Audi', fuel: 'Electric', price: '51.105$',description:'Rapid sloping-roofed coupe', image: etron },
    { title: 'Porsche 911', brand: 'Porsche', fuel: 'Petrol', price: '53.641$',description:'Brilliant sports car ', image: p911},
    { title: 'BMW 8 Series', brand: 'BMW', fuel: 'Diesel', price: '58.327$',description:'Very fast,very comportable coupe', image: serie8},
    { title: 'BMW M240i', brand: 'BMW', fuel: 'Electric', price: '47,414$',description:'Stylish,performance coupe', image: serie240},
    { title: 'Ford Mustang', brand: 'Ford', fuel: 'Electric', price: '52.455$',description:'Muscle powerful coupe', image: mustange},
  ...
  const [open2,setOpen2]=useState(false);
    ...
    return ( 
        ...
        <div className="Navbar pt-4 flex justify-between">
            ...
            <h1 className='Intro ml-4 text-center'>Coupes</h1>
            ...
            />
                ...
                options={[ '30,449$','33,044$','36,044$','37,824$','39,612$','47,414$','51.105$','52.455$','53.641$','58.327$','other prices...']} // Sample prices
