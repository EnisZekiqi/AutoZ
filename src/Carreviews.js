...
/// 3 divs with small medium and big cards /////
     ...
     <div className="carreview">
        ...
        <div className="content-review2">
                    ...
                    <svg
                      ...
                      <p className="mt-4">Mercedes Benz</p>
                      <div style={{width:"max-content"}} className="review2 flex items-center text-center ml-2 mt-4">
                           <p className="ml-1 mr-1">8.5/10</p>
                         </div>
                    </div>
                    <div class="second-content">
                    <div className="flex flex-col">
                          <h2 className="text-center mt-2 font-bold text-lg">Mercedes Benz</h2>
                         <p className="text-center mt-2 text-sm"> Total Reviews : 17.593</p>
                          <div className="flex">
                          <div className="flex justify-end flex-col mt-2">
                          <h3 className="text-center font-bold">What's good</h3>
                        <div className="flex mt-2"> <AddCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Hight-tech </p></div>
                        <div className="flex"> <AddCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Safe car </p></div>
                        <div className="flex"> <AddCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Incredible luxury </p></div>
                         </div>
                         <div className="flex flex-col mt-2">
                          <h3 className="text-center  font-bold">What's bad</h3>
                        <div className="flex ml-4 mt-2"> <RemoveCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Exterior subtle </p></div>
                        <div className="flex  ml-4 "> <RemoveCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Interior scratch easily </p></div>
                        <div className="flex  ml-4 "> <RemoveCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Key feels cheap </p></div>
                         </div>
                          </div>
                         </div>
                    </div>
                  ...
                  <div class="card">
                    ...
                    >
                      ...
                      <div style={{width:"max-content"}} className="review2 mt-4 flex items-center text-center ml-2">
                           <p className="ml-1 mr-1">8/10</p>
                         </div>
                    </div>
                    <div class="second-content">
                    <div className="">
                          <h2 className="text-center mt-2 font-bold text-lg">BMW</h2>
                         <p className="text-center mt-2 text-sm"> Total Reviews : 13.813</p>
                          <div className="flex">
                          <div className="flex  flex-col mt-2">
                          <h3 className="text-center font-bold">What's good</h3>
                        <div className="flex mt-2"> <AddCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Performance </p></div>
                        <div className="flex"> <AddCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Impresive cabin</p></div>
                        <div className="flex"> <AddCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Comfortable </p></div>
                         </div>
                         <div className="flex flex-col mt-2">
                          <h3 className="text-center  font-bold">What's bad</h3>
                        <div className="flex ml-4 mt-2"> <RemoveCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Heavy models </p></div>
                        <div className="flex  ml-4 "> <RemoveCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Not many options </p></div>
                        <div className="flex  ml-4 "> <RemoveCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Headlight problem </p></div>
                         </div>
                          </div>
                         </div>
                    </div>
                  ...
                  <div class="card">
                    ...
                    <div class="second-content">
                    <div className="flex flex-col">
                          <h2 className="text-center mt-2 font-bold text-lg">Audi</h2>
                         <p className="text-center mt-2 text-sm"> Total Reviews : 14.903</p>
                          <div className="flex">
                          <div className="flex flex-col  mt-2">
                          <h3 className="text-center font-bold">What's good</h3>
                        <div className="flex mt-2"> <AddCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Roomy cars</p></div>
                        <div className="flex"> <AddCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Lots high-tech</p></div>
                        <div className="flex"> <AddCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Comfy drive</p></div>
                         </div>
                         <div className="flex flex-col mt-2">
                          <h3 className="text-center  font-bold">What's bad</h3>
                        <div className="flex ml-4 mt-2"> <RemoveCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Sportier alternatives </p></div>
                        <div className="flex  ml-4 "> <RemoveCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Expensive options </p></div>
                        <div className="flex  ml-4 "> <RemoveCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Fiddly touchscreens</p></div>
                         </div>
                          </div>
                         </div>
                    </div>
                  ...
                  <div class="card">
                    ...
                    <div class="second-content">
                    <div className="flex flex-col">
                          <h2 className="text-center mt-2 font-bold text-lg">Porsche</h2>
                         <p className="text-center mt-2 text-sm"> Total Reviews : 12.743</p>
                          <div className="flex">
                          <div className="flex flex-col mt-2">
                          <h3 className="text-center font-bold">What's good</h3>
                        <div className="flex mt-2"> <AddCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Classy yet quick</p></div>
                        <div className="flex"> <AddCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Sporty drive</p></div>
                        <div className="flex"> <AddCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Comfortable</p></div>
                         </div>
                         <div className="flex flex-col mt-2">
                          <h3 className="text-center  font-bold">What's bad</h3>
                        <div className="flex ml-4 mt-2"> <RemoveCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm"> Less practical </p></div>
                        <div className="flex  ml-4 "> <RemoveCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Expensive  </p></div>
                        <div className="flex  ml-4 "> <RemoveCircleIcon sx={{ width:30, color:"#2F27CE"}}/> <p className="text-sm">Mostly Petrol</p></div>
                         </div>
                          </div>
                         </div>
                    </div>
